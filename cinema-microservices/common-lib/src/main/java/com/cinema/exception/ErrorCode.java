...
public enum ErrorCode {
        ...
        BOOKING_SHOWTIME_CINEMA_MISMATCH("4425", "Suất chiếu không thuộc rạp đã chọn", HttpStatus.BAD_REQUEST),
        BOOKING_CANNOT_CANCEL_PAID("4426", "Không thể hủy booking đã thanh toán", HttpStatus.BAD_REQUEST),
        BOOKING_PRODUCT_CINEMA_MISMATCH("4427", "Sản phẩm không thuộc rạp của booking", HttpStatus.BAD_REQUEST),
        BOOKING_PRODUCT_INACTIVE("4428", "Sản phẩm không còn hoạt động", HttpStatus.BAD_REQUEST),
        BOOKING_SEAT_TYPE_MISMATCH("4429", "Loại ghế đã chọn không khớp dữ liệu hệ thống", HttpStatus.BAD_REQUEST),
        SHOWTIME_DATE_REQUIRED("4430", "Vui lòng chọn ngày chiếu", HttpStatus.BAD_REQUEST),
        SHOWTIME_START_TIME_INVALID("4431", "Thời gian bắt đầu suất chiếu phải ở tương lai", HttpStatus.BAD_REQUEST),
        FILM_TYPE_NAME_EXISTED("4432", "Tên thể loại phim đã tồn tại", HttpStatus.CONFLICT),
        ACTOR_NAME_EXISTED("4433", "Tên diễn viên đã tồn tại", HttpStatus.CONFLICT),
        REVIEW_RATING_INVALID("4434", "Điểm đánh giá phải từ 1 đến 5", HttpStatus.BAD_REQUEST),
        REVIEW_CONTENT_REQUIRED("4435", "Nội dung đánh giá không được để trống", HttpStatus.BAD_REQUEST),
        REVIEW_MEDIA_LIMIT_EXCEEDED("4436", "Mỗi đánh giá chỉ được tối đa 5 media", HttpStatus.BAD_REQUEST),
        COMMENT_CONTENT_REQUIRED("4437", "Nội dung bình luận không được để trống", HttpStatus.BAD_REQUEST),
        COMMENT_MEDIA_LIMIT_EXCEEDED("4438", "Mỗi bình luận chỉ được tối đa 5 media", HttpStatus.BAD_REQUEST),
        ...
        PRICING_POLICY_IN_USE("4211", "Chính sách giá đang được suất chiếu sử dụng, không thể xóa hoặc cập nhật",
                        HttpStatus.BAD_REQUEST),
