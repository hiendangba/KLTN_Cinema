...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public ChangePasswordResponse changePassword(ChangePasswordRequest changePasswordRequest, HttpServletResponse response) {
        ...
        switch (otpData.getPurpose()) {
            case REGISTER:
                ...
                try {
                    ...
                    String userServiceCreateUrl = userServiceUrl + "/customer";
                    System.out.println("URL created: " + userServiceCreateUrl);
