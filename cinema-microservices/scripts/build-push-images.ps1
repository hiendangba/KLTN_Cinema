...
Build-And-Push -ServiceName "hall-service" -DockerfilePath "./hall-service/Dockerfile"
...
Build-And-Push -ServiceName "upload-service" -DockerfilePath "./upload-service/upload-service/Dockerfile"
