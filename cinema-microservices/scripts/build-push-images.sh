...
build_and_push "hall-service" "./hall-service/Dockerfile"
build_and_push "cinema-service" "./cinema-service/Dockerfile"
build_and_push "booking-service" "./booking-service/Dockerfile"
build_and_push "seat-service" "./seat-service/Dockerfile"
build_and_push "payment-service" "./payment-service/Dockerfile"
build_and_push "email-service" "./email-service/Dockerfile"
build_and_push "upload-service" "./upload-service/upload-service/Dockerfile"
