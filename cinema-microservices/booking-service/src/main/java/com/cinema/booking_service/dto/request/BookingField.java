...
public enum BookingField {
    ...
    FILM_TITLE("filmTitle", String.class),
    SHOWTIME_START_DATE_TIME("showtimeStartDateTime", LocalDateTime.class),
    SHOWTIME_END_DATE_TIME("showtimeEndDateTime", LocalDateTime.class),
